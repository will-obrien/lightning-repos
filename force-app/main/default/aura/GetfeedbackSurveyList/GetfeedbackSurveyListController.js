({
    doInit : function(component, event, helper) {
        ...
        component.set("v.classDateFrom",today);
        ...
        component.set("v.classDateTo",endDate);
    ...
    fetchSurvey : function(component, event, helper) {
        helper.fetchSurveyResults(component, event, helper);
    },
    
    getSurveyOnChangeDate : function(component, event, helper) {
        helper.fetchSurveyResults(component, event, helper);
    },
    
    getSurveyOnChangeLookUp : function(component, event, helper) {
        helper.fetchSurveyResults(component, event, helper);
    },
    ...
    /*downloadDocument : function(component, event, helper){
        ...
        sendData(dataToSend, 'PDF', companyName, component.get("v.classDateFrom"), component.get("v.classDateTo"), function(){
            //handle callback
        });
    },
    ...
    exportDocument : function(component, event, helper){
        ...
        //invoke vf page js method
        sendData(dataToSend, 'XLS', companyName, component.get("v.classDateFrom"), component.get("v.classDateTo"), function(){
            //handle callback
        });
    }*/
})